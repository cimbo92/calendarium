...
abstract public class AbstractOwmResponse {
	...
	public static String getValueStrFromCalcTimePart (final String calcTimeStr, final String part) {
	...
	public static float getValueFromCalcTimeStr (final String calcTimeStr, final String part) {
